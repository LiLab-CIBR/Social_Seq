...
!!! warning "Important Warning"
    - Currently only supports Ubuntu system and NVIDIA graphics cards. Please refer to relevant materials for other systems. Or use [Playground](../../安装示例流程代码/pipeline_playground_installation) for quick experience.
...
| Software Name | Host Test <br>Version (2022) | Playground in  <br>Docker (👍) |2025 Version  <br> (UnTested) | Notes |
| :----: | :----: | :----: | :----: | :----: |
